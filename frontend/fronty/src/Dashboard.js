...
//  import MasterDataManagement from './MasterDataManagement'; // Add this import
...
//             case 'users':
//                 return <UsersList />;
//             case 'master-data': // Add this case
...
//                         {/* Show Master Data tab only for superadmin */ }
...
//                         {/* /* Show Users tab for superadmin and admin */}
//                         {(user?.role === 'superadmin' || user?.role === 'admin') && (
//                             <button 
//                                 className={`nav-item ${activeTab === 'users' ? 'active' : ''}`}
//                                 onClick={() => setActiveTab('users')}
...
import IssuesList from './IssuesList';
import UsersList from './UsersList';
import MasterDataManagement from './MasterDataManagement'; // Already updated
...
const Dashboard = () => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'users':
                return <UsersList />;
            case 'master-data': // Integrated Back/Next buttons inside MasterDataManagement
                return <MasterDataManagement />;
            default:
                return <DashboardStats />;
        }
